...
function user_setup()
    ...
    state.WeaponskillMode:options('Normal', 'Acc', 'Empty')
	...
	state.WeaponMode = M{['description']='Weapon Mode', 'Kikoku Ternion','Kikoku Kunimitsu', 'Heishi Ternion', 'Heishi Kunimitsu', 'Naegling Uzura +2', 'None'}
	state.RedProc = M{['description']='Red Proc', 'None','Katana','Dagger','Sword', 'Club', 'Staff', 'Great Katana', 'Polearm', 'Scythe', 'Great Sword'}
...
--	send_command('equipviewer pos 2160 400')
    ...
    send_command('bind !w exec weaponmode.txt')
    send_command('bind @a gs c cycle AttackMode')
	send_command('bind @r exec redproc.txt')
--	send_command('bind @r gs c set WeaponMode None')
	send_command('bind @t exec redprocback.txt')
...
function init_gear_sets()
    ...
    sets.Enmity = {
        ...
        feet="Mochi. Kyahan +1", --8
        neck="Moonlight Necklace", --15
        ear1="Cryptic Earring", --4
        ear2="Trux Earring", --5
        ring1="Pernicious Ring", --5
        ring2="Vengeful Ring", --5
        waist="Kasiri Belt", --3
        }
    ...
    sets.precast.FC = {
        ...
        back={name="Andartia's Mantle", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10','Spell interruption rate down-10%',}}, --10
        waist="Sailfi Belt +1",
        }
...
--		body={ name="Herculean Vest", augments={'"Mag.Atk.Bns."+9','Weapon skill damage +4%','STR+14',}},
--        hands={ name="Herculean Gloves", augments={'Mag. Acc.+9','Weapon skill damage +4%','STR+7','"Mag.Atk.Bns."+15',}},
--        hands="Nyame gauntlets",
--        legs={ name="Mochi. Hakama +3", augments={'Enhances "Mijin Gakure" effect',}},
--        feet={ name="Herculean Boots", augments={'"Mag.Atk.Bns."+15','Weapon skill damage +4%','INT+5','Mag. Acc.+3',}},body={ name="Herculean Vest", augments={'"Mag.Atk.Bns."+9','Weapon skill damage +4%','STR+14',}},
--        hands={ name="Herculean Gloves", augments={'Mag. Acc.+9','Weapon skill damage +4%','STR+7','"Mag.Atk.Bns."+15',}},
		neck="Baetyl Pendant",
        ear1="Moonshade Earring",
    ...
    sets.precast.WS['Blade: Ten'].Empty = sets.precast.WS.Empty
...
--        feet="Ken. Sune-Ate +1",
	...
	sets.precast.WS['Blade: Ku'].Empty = sets.precast.WS.Empty
...
sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {
    ...
    sets.midcast.SpellInterrupt = {
        ...
        back={name="Andartia's Mantle", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10','Spell interruption rate down-10%',}}, --10 --10
...
--    sets.midcast.Utsusemi = set_combine(sets.midcast.SpellInterrupt, {feet="Hattori Kyahan +1", back=gear.NIN_FC_Cape,})
    ...
    sets.midcast['Raiton: San'] = set_combine(sets.midcast.ElementalNinjutsu, {
        ammo=empty,
		range="Donar Gun",
        })
...
--    sets.resting = {}
    ...
    sets.engaged.Hybrid = {
		...
		legs="Malignance Tights",
        ring2="Defending Ring", --10/10
        back={name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Phys. dmg. taken-10%',}}, --10/0
        }
	sets.engaged.Crit = {
	    head="Mummu Bonnet +2",
        body="Mummu Jacket +2",
    ...
    sets.engaged.KikokuTernion = {
 		main="Kikoku",
        sub="Ternion Dagger +1",
        }
    sets.engaged.KikokuTauret = {
 		main="Kikoku",
        sub="Kunimitsu",
        }
    sets.engaged.HeishiTernion = {
 		main="Heishi Shorinken",
        sub="Ternion Dagger +1",
        }
    sets.engaged.HeishiTauret = {
 		main="Heishi Shorinken",
        sub="Kunimitsu",
        }
	sets.engaged.NaeglingUzura = {
 		main="Naegling",
        sub="Uzura +2",
        }	
    sets.engaged.RedKatana = {
 		main={name="Kunai", bag="wardrobe4"},
        sub={name="Kunai", bag="wardrobe"},
		ammo="Yamarang",
        }
	sets.engaged.RedDagger = {
 		main="Aern Dagger",
        sub="Kunai",
		ammo="Yamarang",
        }
	sets.engaged.RedSword = {
 		main="Wax Sword",
        sub="Kunai",
		ammo="Yamarang",
        }
	sets.engaged.RedClub = {
 		main="Ash Club",
        sub="Kunai",
		ammo="Yamarang",
        }
	sets.engaged.RedStaff = {
 		main="Lamia Staff",
		ammo="Yamarang",
        }
	sets.engaged.RedGK = {
    ...
    sets.magic_burst = {
        main={name="Ochu", bag="wardrobe1"},
		sub={name="Ochu", bag="wardrobe3"},
		body="Samnuha Coat",
		feet="Hachiya Kyahan +2",
        ring1="Locus Ring",
        ring2="Mujin Band", --(5)
...
function customize_melee_set(meleeSet)
	...
	if state.CritMode.Current == 'On' then
	   meleeSet = set_combine(meleeSet, sets.engaged.Crit)
	elseif state.CritMode == 'Off' then
	return meleeSet
	end
	if state.RedProc.Current == 'None' and state.WeaponMode.Current == 'Kikoku Ternion' then
	    meleeSet = set_combine(meleeSet, sets.engaged.KikokuTernion)
	elseif state.RedProc.Current == 'None' and state.WeaponMode.Current == 'Kikoku Kunimitsu' then
	    meleeSet = set_combine(meleeSet, sets.engaged.KikokuTauret)
	elseif state.RedProc.Current == 'None' and state.WeaponMode.Current == 'Heishi Ternion' then
	    meleeSet = set_combine(meleeSet, sets.engaged.HeishiTernion)
	elseif state.RedProc.Current == 'None' and state.WeaponMode.Current == 'Heishi Kunimitsu' then
	    meleeSet = set_combine(meleeSet, sets.engaged.KikokuTauret)
	elseif state.RedProc.Current == 'None' and state.WeaponMode.Current == 'Naegling Uzura +2' then
	    meleeSet = set_combine(meleeSet, sets.engaged.NaeglingUzura)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Katana' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedKatana)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Dagger' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedDagger)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Sword' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedSword)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Club' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedClub)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Staff' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedStaff)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Great Katana' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedGK)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Polearm' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedPA)
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Scythe' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedScythe)	
	elseif state.WeaponMode.Current == 'None' and state.RedProc.Current == 'Great Sword' then
	    meleeSet = set_combine(meleeSet, sets.engaged.RedGS)
	end
    return meleeSet
