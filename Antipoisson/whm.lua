...
--        back="Twilight Cape",
    ...
    sets.idle = {
        ...
        sub="Genmei Shield",
        ammo="Homiliary",
        head={ name="Chironic Hat", augments={'STR+9','Potency of "Cure" effect received+1%','"Refresh"+2','Accuracy+5 Attack+5',}},
        body="Inyanga Jubbah +2",
        hands={ name="Chironic Gloves", augments={'DEX+8','Pet: Accuracy+19 Pet: Rng. Acc.+19','"Refresh"+2','Accuracy+16 Attack+16',}},
        legs="Assid. Pants +1",
        feet={ name="Chironic Slippers", augments={'Mag. Acc.+3','CHR+9','"Refresh"+2','Accuracy+18 Attack+18','Mag. Acc.+2 "Mag.Atk.Bns."+2',}},
        neck="Bathy Choker +1",
        ear1="Eabani Earring",
        ear2="Sanare Earring",
        ring1={name="Stikini Ring +1", bag="wardrobe"},
