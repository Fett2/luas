...
function user_setup()
    ...
    state.Gun = M{['description']='Current Gun', 'Fomalhaut', 'Anarchy +2', 'Death Penalty',}--, 'Armageddon'
...
function init_gear_sets()
    ...
    sets.idle.DT = set_combine(sets.idle, {
        ...
        waist="Flume Belt +1", --4/0
		feet={ name="Herculean Boots", augments={'STR+13','Enmity-4','Damage taken-4%','Accuracy+14 Attack+14',}}
        })
    ...
    sets.engaged.Hybrid = {
        head={ name="Adhemar Bonnet +1", augments={'HP+105','Attack+13','Phys. dmg. taken -4',}}, --4/0
	--	body="Meg. Cuirie +2",
		hands={ name="Herculean Gloves", augments={'Rng.Acc.+16','Damage taken-4%','Accuracy+12','Attack+6',}}, --6/4
        neck="Loricate Torque +1", --6/6
	--	ring1="Warden's Ring",
		ring2="Defending Ring", --10/10
	--	waist="Flume Belt +1" --4/0pdt
	--  feet={ name="Herculean Boots", augments={'STR+13','Enmity-4','Damage taken-4%','Accuracy+14 Attack+14',}}
        }
    ...
    sets.CP = {
	head = "Wh. Rarab Cap +1",
	body={ name="Herculean Vest", augments={'Pet: Phys. dmg. taken -1%','"Mag.Atk.Bns."+24','"Treasure Hunter"+1',}},
	waist = "Chaac Belt",
	}
--	back="Mecisto. Mantle"}
