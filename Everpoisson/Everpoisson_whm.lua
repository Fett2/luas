...
function user_setup()
	...
	include('sendbindsever.lua')
--    include('Global-GEO-Binds.lua') -- OK to remove this line
    send_command('bind ^a input /ma "Aurorastorm" <me>')
...
--        ring1="Kishar Ring", --4
        ...
        back={ name="Alaunus's Cape", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10',}}, --10
        waist="Embla Sash", --5
        }
-- 54 FC
    ...
    sets.midcast.CureSolace = {
        ...
        head="Ebers Cap +1", --16
        body="Ebers Bliaud +1",
        hands="Theophany Mitts +2", --0(+2)/(-6)
        legs="Ebers Pant. +1",
        feet="Vanya Clogs", --10
        neck="Clr. Torque +1", --10
        ear1="Glorious Earring", -- (+2)/(-5)
        ear2="Meili Earring", --5
        ring1="Lebeche Ring", --3/(-5)
        ring2="Menelaus's Ring", --5
        back={ name="Alaunus's Cape", augments={'MND+20','Eva.+20 /Mag. Eva.+20','MND+10','"Cure" potency +10%','Mag. Evasion+15',}}, --10
        waist="Bishop's Sash",
		--Cure pot 58
		--Cur pot 2 4
		-- -Enmity 35
...
--        back="Twilight Cape",
    ...
    sets.midcast.StatusRemoval = {
        ...
        back={ name="Alaunus's Cape", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10',}},
        waist="Embla Sash",
        }
    ...
    sets.midcast.Cursna = set_combine(sets.midcast.StatusRemoval, {
        ...
        back={ name="Alaunus's Cape", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10',}}, --25
        waist="Bishop's Sash",
        })
    ...
    sets.midcast['Enhancing Magic'] = {
        main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','MND+7','DMG:+14',}},
        sub="Ammurapi Shield",
    ...
    sets.idle = {
        ...
        sub="Genmei Shield",
        ammo="Homiliary",
        head={ name="Chironic Hat", augments={'Pet: DEX+7','CHR+10','"Refresh"+2',}},
        body="Inyanga Jubbah +2",
        hands={ name="Chironic Gloves", augments={'Enmity+1','Magic dmg. taken -2%','"Refresh"+2',}},
        legs="Assid. Pants +1",
        feet={ name="Chironic Slippers", augments={'Pet: Accuracy+30 Pet: Rng. Acc.+30','Phys. dmg. taken -3%','"Refresh"+2',}},
        neck="Bathy Choker +1",
        ear1="Moonshade Earring",
        ear2="Sanare Earring",
        ring1={name="Stikini Ring +1", bag="wardrobe"},
        ring2={name="Stikini Ring +1", bag="wardrobe2"},
        back={ name="Alaunus's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','HP+20','Mag. Evasion+15',}},
